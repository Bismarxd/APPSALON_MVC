...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $contenido .= "<p>Presiona aquí: <a href='http://localhost:3500/confirmar-cuenta?token=" . $this->token . "'>Confirmar Cuenta</a> </p>";
    ...
    public function enviarInstrucciones()
    {
          ...
          $contenido .= "<p>Presiona aquí: <a href='http://localhost:3500/recuperar?token=" . $this->token . "'>Reestablecer Password</a> </p>";
          $contenido .= "<p>Si tu no solicitaste esta cuenta, puedes ignorar el mensaje</p>";
          $contenido .= "</html>";
